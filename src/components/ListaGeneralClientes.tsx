...
import { Search, Phone, MessageSquare, DollarSign, Filter, Clock, AlertCircle, CheckCircle, Menu, X } from 'lucide-react';
...
export default function ListaGeneralClientes({
  ...
  // Ordenar clientes priorizando estados críticos
